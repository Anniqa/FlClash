...
sendfd(JNIEnv *env, jobject thiz, jint tun_fd) {
    ...
    strncpy(addr.sun_path, "/data/data/com.follow.clash/sock_path", sizeof(addr.sun_path) -1);
...
static const char *classPathName = "com/follow/clash/service/zivpn/NativeSystem";
