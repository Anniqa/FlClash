...
mixin _$VpnOptions {
 ...
 bool get enable; int get port; bool get ipv6; bool get dnsHijacking; AccessControlProps get accessControlProps; bool get allowBypass; bool get systemProxy; List<String> get bypassDomain; String get stack; List<String> get routeAddress; String get backend; String get zivpnServer; String get zivpnPortRange; String get zivpnPassword; String get zivpnObfs; bool get zivpnEnableUdpGw; int get zivpnUdpGwPort; int get zivpnCoreCount;
...
@useResult
$Res call({
 bool enable, int port, bool ipv6, bool dnsHijacking, AccessControlProps accessControlProps, bool allowBypass, bool systemProxy, List<String> bypassDomain, String stack, List<String> routeAddress, String backend, String zivpnServer, String zivpnPortRange, String zivpnPassword, String zivpnObfs, bool zivpnEnableUdpGw, int zivpnUdpGwPort, int zivpnCoreCount
});
...
/// Create a copy of VpnOptions
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? enable = null,Object? port = null,Object? ipv6 = null,Object? dnsHijacking = null,Object? accessControlProps = null,Object? allowBypass = null,Object? systemProxy = null,Object? bypassDomain = null,Object? stack = null,Object? routeAddress = null,Object? backend = null,Object? zivpnServer = null,Object? zivpnPortRange = null,Object? zivpnPassword = null,Object? zivpnObfs = null,Object? zivpnEnableUdpGw = null,Object? zivpnUdpGwPort = null,Object? zivpnCoreCount = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool enable,  int port,  bool ipv6,  bool dnsHijacking,  AccessControlProps accessControlProps,  bool allowBypass,  bool systemProxy,  List<String> bypassDomain,  String stack,  List<String> routeAddress,  String backend,  String zivpnServer,  String zivpnPortRange,  String zivpnPassword,  String zivpnObfs,  bool zivpnEnableUdpGw,  int zivpnUdpGwPort,  int zivpnCoreCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _VpnOptions() when $default != null:
return $default(_that.enable,_that.port,_that.ipv6,_that.dnsHijacking,_that.accessControlProps,_that.allowBypass,_that.systemProxy,_that.bypassDomain,_that.stack,_that.routeAddress,_that.backend,_that.zivpnServer,_that.zivpnPortRange,_that.zivpnPassword,_that.zivpnObfs,_that.zivpnEnableUdpGw,_that.zivpnUdpGwPort,_that.zivpnCoreCount);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool enable,  int port,  bool ipv6,  bool dnsHijacking,  AccessControlProps accessControlProps,  bool allowBypass,  bool systemProxy,  List<String> bypassDomain,  String stack,  List<String> routeAddress,  String backend,  String zivpnServer,  String zivpnPortRange,  String zivpnPassword,  String zivpnObfs,  bool zivpnEnableUdpGw,  int zivpnUdpGwPort,  int zivpnCoreCount)  $default,) {final _that = this;
switch (_that) {
case _VpnOptions():
return $default(_that.enable,_that.port,_that.ipv6,_that.dnsHijacking,_that.accessControlProps,_that.allowBypass,_that.systemProxy,_that.bypassDomain,_that.stack,_that.routeAddress,_that.backend,_that.zivpnServer,_that.zivpnPortRange,_that.zivpnPassword,_that.zivpnObfs,_that.zivpnEnableUdpGw,_that.zivpnUdpGwPort,_that.zivpnCoreCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool enable,  int port,  bool ipv6,  bool dnsHijacking,  AccessControlProps accessControlProps,  bool allowBypass,  bool systemProxy,  List<String> bypassDomain,  String stack,  List<String> routeAddress,  String backend,  String zivpnServer,  String zivpnPortRange,  String zivpnPassword,  String zivpnObfs,  bool zivpnEnableUdpGw,  int zivpnUdpGwPort,  int zivpnCoreCount)?  $default,) {final _that = this;
switch (_that) {
case _VpnOptions() when $default != null:
return $default(_that.enable,_that.port,_that.ipv6,_that.dnsHijacking,_that.accessControlProps,_that.allowBypass,_that.systemProxy,_that.bypassDomain,_that.stack,_that.routeAddress,_that.backend,_that.zivpnServer,_that.zivpnPortRange,_that.zivpnPassword,_that.zivpnObfs,_that.zivpnEnableUdpGw,_that.zivpnUdpGwPort,_that.zivpnCoreCount);case _:
  return null;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,enable,port,ipv6,dnsHijacking,accessControlProps,allowBypass,systemProxy,const DeepCollectionEquality().hash(_bypassDomain),stack,const DeepCollectionEquality().hash(_routeAddress),backend,zivpnServer,zivpnPortRange,zivpnPassword,zivpnObfs,zivpnEnableUdpGw,zivpnUdpGwPort,zivpnCoreCount);
